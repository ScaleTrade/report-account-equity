...
extern "C" void AboutReport(rapidjson::Value&                   request,
    ...
    response.AddMember(
        ...
        Value().SetString("The financial status of a specific account over a given interval.",
                          allocator),
        allocator);
    response.AddMember("type", static_cast<int>(ReportType::RANGE_ACCOUNT), allocator);
}
...
extern "C" void CreateReport(rapidjson::Value&                   request,
    ...
    //
    // // Balance chart
    // const JSONArray balance_chart_data =
    // utils::CreateBalanceChartData(usd_converted_equity_vector);
    //
    ...
    //          Legend(),
    //
    //          Line({}, props({{"type", "monotone"}, {"dataKey", "balance"}, {"stroke",
    //          "#4A90E2"}})),
    //
    //          Line({}, props({{"type", "monotone"}, {"dataKey", "credit"}, {"stroke",
    //          "#7ED321"}})),
    //
    //          Line({}, props({{"type", "monotone"}, {"dataKey", "equity"}, {"stroke",
    //          "#F5A623"}})),
    //
    //          Line({}, props({{"type", "monotone"}, {"dataKey", "profit"}, {"stroke",
    //          "#9013FE"}}))},
    ...
    // table_builder.SetOrderBy("CREATE_TIME", "DESC");
